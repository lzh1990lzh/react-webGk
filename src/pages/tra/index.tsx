...
import { Form, Button, DatePicker, Image, Modal, Space, message } from 'antd';
import {
  LoadingOutlined,
  PlusOutlined
...
    setEndTime(endTime)
  ...
  function imageChange(file: any, url: string) {
    ...
    setHeadPath(url);
    console.log(setHeadPath,"---setHeadPath");
    setImgLoading(false);
  }
  ...
  return (
    <div className={styles['pot-wrapper']}>
      ...
      <div className={styles['pot-container']}>
        <div className={styles['pot-title']}>人像轨迹</div>
